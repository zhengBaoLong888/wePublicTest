...
var sArray = new Object;
 ...
 function initStar() {
  try {
   ...
   setProfix("taste_");
   setStars(document.getElementById("rating2").value,'rating2');
   setProfix("price_");
   setStars(document.getElementById("rating3").value,'rating3');
   setProfix("environment_");
   setStars(document.getElementById("rating4").value,'rating4');
   setProfix("service_");
   setStars(document.getElementById("rating5").value,'rating5');
  } catch(e){
  }
 }
